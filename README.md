...
Now that has already been set up, you can create a ``conda`` environment and set up its environment as ``Python 3.10.13``:
<pre>
<code>$ conda create -n neural_nine python=3.10.13</code>
</pre>
