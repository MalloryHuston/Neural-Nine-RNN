...
It is highly recommended to run this program in a ``conda`` environment. You can find further instructions on how to install ``miniconda.sh`` on your computer based on its operating system <a href="https://www.anaconda.com/docs/getting-started/miniconda/install#quickstart-install-instructions">here.</a>

Now, download and install ``miniconda.sh`` by following these steps:
